...
import { getStaticData, getStaticDataForCategory, StaticData } from '@/lib/static-data';
import { StatsCardSkeleton, CategoryCardSkeleton, WordCardSkeleton } from '@/components/ui/skeleton';
